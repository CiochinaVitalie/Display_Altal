#line 1 "C:/Users/Vitalii/Desktop/alta_2_compressor_display/Controller_Code/mikroC PRO for ARM/Gauge.c"
...
#line 1 "c:/users/vitalii/documents/mikroelektronika/mikroc pro for arm/include/stdbool.h"
 ...
 typedef char _Bool;
#line 1 "c:/users/vitalii/documents/mikroelektronika/mikroc pro for arm/include/stdlib.h"
...
#line 20 "C:/Users/Vitalii/Desktop/alta_2_compressor_display/Controller_Code/mikroC PRO for ARM/Gauge.c"
...
void HP_display(int pressure)
{
 ...
 if( HP_pressure <= 0.0f )
 {
 current_line.x1 = ( int )(  126.0f  + (  5.0f  * sin( 185.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.y1 = ( int )(  128.0f  + (  5.0f  * -cos( 185.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.x2 = ( int )(  126.0f  + (  80.0f  * sin( 185.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.y2 = ( int )(  128.0f  + (  80.0f  * -cos( 185.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 }
 else if( HP_pressure >= 360.0f )
 {
 current_line.x1 = ( int )(  126.0f  + (  5.0f  * sin( 176.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.y1 = ( int )(  128.0f  + (  5.0f  * -cos( 176.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.x2 = ( int )(  126.0f  + (  80.0f  * sin( 176.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.y2 = ( int )(  128.0f  + (  80.0f  * -cos( 176.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 }
 else
 {
 current_line.x1 = ( int )(  126.0f  + (  5.0f  * sin( (HP_pressure +180)*
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.y1 = ( int )(  128.0f  + (  5.0f  * -cos( (HP_pressure +180) *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.x2 = ( int )(  126.0f  + (  80.0f  * sin( (HP_pressure +180) *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.y2 = ( int )(  128.0f  + (  80.0f  * -cos( (HP_pressure +180) *
 (  3.14159265f  / 180.0f ) ) ) );
 }
...
void LP_display(int pressure)
{
 ...
 if( LP_pressure <= 0.0f )
 {
 current_line.x1 = ( int )(  344.0f  + (  5.0f  * sin( 185.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.y1 = ( int )(  128.0f  + (  5.0f  * -cos( 185.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.x2 = ( int )(  344.0f  + (  80.0f  * sin( 185.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.y2 = ( int )(  128.0f  + (  80.0f  * -cos( 185.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 }
 ...
 {
 current_line.x1 = ( int )(  344.0f  + (  5.0f  * sin( 176.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.y1 = ( int )(  128.0f  + (  5.0f  * -cos( 176.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.x2 = ( int )(  344.0f  + (  80.0f  * sin( 176.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.y2 = ( int )(  128.0f  + (  80.0f  * -cos( 176.0f *
 (  3.14159265f  / 180.0f ) ) ) );
 }
 ...
 {
 current_line.x1 = ( int )(  344.0f  + (  5.0f  * sin( ( LP_pressure + 180)*
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.y1 = ( int )(  128.0f  + (  5.0f  * -cos( ( LP_pressure + 180) *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.x2 = ( int )(  344.0f  + (  80.0f  * sin( ( LP_pressure + 180) *
 (  3.14159265f  / 180.0f ) ) ) );
 current_line.y2 = ( int )(  128.0f  + (  80.0f  * -cos( ( LP_pressure + 180) *
 (  3.14159265f  / 180.0f ) ) ) );
 }
