_HP_display:
;Gauge.c,35 :: 		void HP_display()
SUB	SP, SP, #8
STR	LR, [SP, #0]
;Gauge.c,41 :: 		HP_pressure = system_reg[HIGH_PRESS_1]*10.0 + 5;
...
VMOV	R1, S0
SXTH	R1, R1
MOVW	R0, #lo_addr(_current_line+0)
MOVT	R0, #hi_addr(_current_line+0)
STRH	R1, [R0, #0]
...
VMOV	R1, S0
SXTH	R1, R1
MOVW	R0, #lo_addr(_current_line+2)
MOVT	R0, #hi_addr(_current_line+2)
STRH	R1, [R0, #0]
...
VMOV	R1, S0
SXTH	R1, R1
MOVW	R0, #lo_addr(_current_line+4)
MOVT	R0, #hi_addr(_current_line+4)
STRH	R1, [R0, #0]
...
VMOV	R1, S0
SXTH	R1, R1
MOVW	R0, #lo_addr(_current_line+6)
MOVT	R0, #hi_addr(_current_line+6)
STRH	R1, [R0, #0]
;Gauge.c,59 :: 		}
IT	AL
BAL	L_HP_display3
...
; end of _HP_display
_LP_display:
;Gauge.c,87 :: 		void LP_display()
SUB	SP, SP, #8
STR	LR, [SP, #0]
;Gauge.c,94 :: 		LP_pressure = system_reg[LOW_PRESS_1] * 33.3 + 42;
