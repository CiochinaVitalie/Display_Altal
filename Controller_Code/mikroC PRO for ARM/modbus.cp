#line 1 "C:/Users/User/Desktop/Display_2_compressor/ALTAL_TFT/Controller_Code/mikroC PRO for ARM/modbus.c"
...
#line 8 "C:/Users/User/Desktop/Display_2_compressor/ALTAL_TFT/Controller_Code/mikroC PRO for ARM/modbus.c"
...
void constructPacket()
{
 ...
 frame[2] =  ((char *)&bus_data.address)[1]  ;
 frame[3] =  ((char *)&bus_data.address)[0] ;
 ...
 frame[6] =  ((char *)&crc16)[1] ;
 frame[7] =  ((char *)&crc16)[0] ;
 sendbus_data(8);
 }
}
...
void check_F16_data()
{
 ...
 unsigned int recieved_crc = ((frame[6] << 8) | frame[7]);
 unsigned int calculated_crc = calculateCRC(6);
