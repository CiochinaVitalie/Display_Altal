#line 1 "C:/Users/Dumitru/Desktop/dima/alta_2_compressor_display/Controller_Code/mikroC PRO for ARM/DataConvertor.c"
...
#line 9 "C:/Users/Dumitru/Desktop/dima/alta_2_compressor_display/Controller_Code/mikroC PRO for ARM/DataConvertor.c"
...
float ReadHighPressure (int high_press){
 return ((high_press -  102.0 ) *  34.0 / ( 922.0  -  102.0 ));
}


float ReadLowPressure (int low_press){
 return ((low_press -  102.0 ) *  18.0 / ( 922.0  -  102.0 ) );
}
...
int calc_temperature(unsigned int adcsum) {
 ...
 res -= (( -50  * (int32_t)(adcsum - vr) + (vd >> 1)) / vd);
 }
 return res;
}
